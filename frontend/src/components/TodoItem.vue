<template>
  <div :class="[styles.todoItem, { [styles.completed]: todo.completed }]">
    ...
    <div :class="styles.todoActions">
      <button @click="editTodo" :class="styles.btnEdit">
      ...
      <button @click="deleteTodo" :class="styles.btnDelete">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          class="size-6">
          <path stroke-linecap="round" stroke-linejoin="round"
...
const deleteTodo = async () => {
  const confirmed = await confirmDelete(
    props.todo.name,
    `Ce todo sera définitivement supprimé de votre liste.`
  );
